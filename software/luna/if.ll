...
@7 = private unnamed_addr constant [4 x i8] c"hmm\00", align 1
@8 = private unnamed_addr constant [10 x i8] c"not other\00", align 1
@9 = private unnamed_addr constant [5 x i8] c"lame\00", align 1
...
if.then:                                          ; preds = %entry
  ...
  store ptr @11, ptr %inner, align 8
